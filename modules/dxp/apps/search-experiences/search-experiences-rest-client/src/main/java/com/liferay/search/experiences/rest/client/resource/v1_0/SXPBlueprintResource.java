...
public interface SXPBlueprintResource {
	...
	public HttpInvoker.HttpResponse
			postSXPBlueprintSetAsCollectionProviderHttpResponse(
				Long sxpBlueprintId, Boolean collectionProvider)
		throws Exception;
	...
	public static class SXPBlueprintResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			if (collectionProvider != null) {
				httpInvoker.parameter(
					"collectionProvider", String.valueOf(collectionProvider));
			}

			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/search-experiences-rest/v1.0/sxp-blueprints/{sxpBlueprintId}/set-as-collection-provider");
