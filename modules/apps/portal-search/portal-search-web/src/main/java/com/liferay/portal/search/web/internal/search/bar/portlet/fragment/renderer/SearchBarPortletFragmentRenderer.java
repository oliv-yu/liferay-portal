...
package com.liferay.portal.search.web.internal.search.bar.portlet.fragment.renderer;
...
public class SearchBarPortletFragmentRenderer implements FragmentRenderer {
	...
	public String getConfiguration(
		...
		try {
			JSONObject jsonObject = _jsonFactory.createJSONObject(
				StringUtil.read(
					getClass(),
					"/com/liferay/portal/search/web/internal/search/bar/web" +
	...
	public String getLabel(Locale locale) {
		return _language.get(
			locale, "search-bar-portlet-instance-configuration-name");
	}
	...
	private String _buildFragmentHTML(
		...
		ComponentDescriptor componentDescriptor = new ComponentDescriptor(
			"{SearchBarFragment} from portal-search-web",
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SearchBarPortletFragmentRenderer.class);
