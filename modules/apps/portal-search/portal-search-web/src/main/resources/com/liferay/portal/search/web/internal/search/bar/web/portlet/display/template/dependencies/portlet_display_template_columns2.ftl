...
<@liferay_aui.script>
	function ${namespace}renderSuggestions(suggestionGroups, searchURL) {
		return '<ul class="list-unstyled"><div class="row c-ml-0 c-mr-0">' +
				(suggestionGroups[1] ?
					'<div class="col-md-6 c-pl-0">' +
						${namespace}renderSuggestionGroup(suggestionGroups[0]) +
					'</div>' +
					'<div class="col-md-6">' +
						${namespace}renderSuggestionGroup(suggestionGroups[1]) +
					'</div>'
					:
					'<div class="col-md-12 c-pl-0">' +
						${namespace}renderSuggestionGroup(suggestionGroups[0]) +
					'</div>'
				) +
			'</div></ul>' +
	...
	function ${namespace}renderSuggestionGroup(suggestionGroup) {
		return (
							...
							'<div class="d-flex">' +
								(suggestion.attributes.assetURL ?
									'<div class="autofit-col">' +
										'<img class="c-mr-2" style="max-height:50px;" src="' +
										'/o/commerce-media/default/?groupId=43862' + '">' +
									'</div>'
									: '') +
								'<div class="align-self-center autofit-col autofit-col-expand">' +
