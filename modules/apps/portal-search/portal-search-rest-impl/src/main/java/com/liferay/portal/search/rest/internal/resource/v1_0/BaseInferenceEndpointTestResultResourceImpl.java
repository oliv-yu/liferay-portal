...
public abstract class BaseInferenceEndpointTestResultResourceImpl
	implements InferenceEndpointTestResultResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search/v1.0/inference-endpoint/test'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "InferenceEndpointTestResult"
			)
		}
	)
	@jakarta.ws.rs.Path("/inference-endpoint/test")
	@jakarta.ws.rs.POST
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(
			BaseInferenceEndpointTestResultResourceImpl.class);

}
// LIFERAY-REST-BUILDER-HASH:-568909226