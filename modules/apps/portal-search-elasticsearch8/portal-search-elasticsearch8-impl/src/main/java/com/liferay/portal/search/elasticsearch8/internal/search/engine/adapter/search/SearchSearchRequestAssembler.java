 ...
 */
public class SearchSearchRequestAssembler {

	public static final SearchSearchRequestAssembler INSTANCE =
		new SearchSearchRequestAssembler();
	...
	private SearchSearchRequestAssembler() {
	}
